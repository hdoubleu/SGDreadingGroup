...
- $g(\boldsymbol{\theta})$ is the gradient function
    ...
    + 1st derivative of L($\boldsymbol{\theta}$):
...
- May not converge
- Local minimum
- Bottou (2010) refers to Robbins and Siegmund (1971, repub 1985) as the
  source for the theory on convergence
...
- Different $\alpha$:
      + In Newton–Raphson, it's the inverse of the 2nd derivative matrix (Hessian)
